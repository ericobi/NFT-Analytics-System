...
const abi = [
  ...
  {
    constant: false,
    inputs: [{ name: "_newBaseMetadataURI", type: "string" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: "_uri", type: "string" },
...
export const create = (address, provider) => {
  const contract = new Contract(address, abi, provider);

  // READ
  const balanceOfBatch = (owners, ids) => contract.balanceOfBatch(owners, ids);

  const balanceOf = (owner, id) => contract.balanceOf(owner, id);
